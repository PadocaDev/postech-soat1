...
public class BuscaPedidoCasoDeUso implements BuscaPedidoCasoDeUsoInterface {
    ...
    @Override
    public List<Pedido> buscarTodosPedidosNaoFinalizados(PedidoGatewayInterface pedidoGatewayInterface) {
       return pedidoGatewayInterface.buscarTodosPedidosNaoFinalizados();
    }
}